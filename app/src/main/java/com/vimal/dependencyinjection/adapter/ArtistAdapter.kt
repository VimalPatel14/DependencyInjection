package com.vimal.dependencyinjection.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.bumptech.glide.Glide
import com.vimal.dependencyinjection.databinding.ArtistItemviewBinding
import com.vimal.dependencyinjection.databinding.ItemShimmerLyoutBinding
import com.vimal.dependencyinjection.model.artist.Artist
import com.vimal.dependencyinjection.model.artist.ArtistDataType
import com.vimal.dependencyinjection.model.artist.ArtistDto
...
class ArtistAdapter() : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class ShimmerViewHolder(val binding: ItemShimmerLyoutBinding) :
        RecyclerView.ViewHolder(binding.root) {

    }

    inner class ArtistViewHolder(val binding: ArtistItemviewBinding) :
        RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        when (viewType) {
            ArtistDataType.SHIMMER.value -> {
                val binding = ItemShimmerLyoutBinding.inflate(
                ...
                val binding = ArtistItemviewBinding.inflate(
                    LayoutInflater.from(parent.context),
                    parent,
                    false
                )
